...
interface AltOrderSignaturesSectionProps {
  // Account Owner
...
export function AltOrderSignaturesSection({
  ...
  hasJointOwner = false,
}: AltOrderSignaturesSectionProps) {
  return (
    <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <SignatureField
                ...
                onBlur={() => onAccountOwnerBlur?.("signature")}
                error={accountOwnerErrors?.signature}
              />
            </div>
            <div>
              <TextField
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <SignatureField
                  ...
                  onBlur={() => onJointAccountOwnerBlur?.("signature")}
                  error={jointAccountOwnerErrors?.signature}
                />
              </div>
              <div>
                <TextField
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <SignatureField
                ...
                onBlur={() => onFinancialProfessionalBlur?.("signature")}
                error={financialProfessionalErrors?.signature}
              />
            </div>
            <div>
              <TextField
